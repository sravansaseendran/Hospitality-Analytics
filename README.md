...
Developed an interactive Hospitality Analytics Dashboard to analyze hotel performance and support data-driven decision-making across multiple properties and cities. The project focuses on transforming raw booking and revenue data into meaningful business insights.
...
- City and property level analysis
- Weekly and monthly performance trends

Key Outcomes
- Built an interactive Power BI dashboard
- Identified performance patterns and business insights
...
Findings:
	...
	Monthly revenue is declining from May to July, revealing seasonal or strategic weaknesses.
	Weekend revenue and bookings are much lower than weekday levels, showing over-dependence on business travelers.
	The average guest rating of 3.62 suggests only moderate customer satisfaction and inconsistent service quality.
    The business heavily relies on a few booking platforms, increasing risk and commission expenses.
